...
void exact_parameters(int m, int n, double T, double U, double mu, double s, double r, std::string fixed_param, double sigma_T = 0.0, double delta_U = 0.0, double delta_u = 0.0, int realizations = 1, std::string scale = "log");
...
double compute_param(double p_min, double p_max, int idx, int num_points, const std::string& scale);
}